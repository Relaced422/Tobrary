        ...
        <?php if ($_SESSION == null) { ?>
                <div class="flex gap-8 w-full max-w-4xl">
                    ...
                    <div
                        ...
                        <?php
                        include 'logic-php/register.php';
                        ?>
                    </div>
                </div>
        <?php } else { ?>
            <div class="flex flex-col justify-center text-center">
                ...
                if (isset($_SESSION['userId'])) {
                    echo "Welkom, " . $_SESSION['firstName'] . " " . $_SESSION['lastName'];
                }
                ?>
                <form action="" method="post">
                    <button name="logout" class="px-6 py-3 bg-red-500 text-white rounded-lg" type="submit">
                        Log uit
                    </button>
                </form>
                <?php
